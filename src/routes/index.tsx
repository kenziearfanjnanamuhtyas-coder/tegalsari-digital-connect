...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Website resmi Desa Tegalsari, Kecamatan Sidareja, Kabupaten Cilacap, Jawa Tengah. Informasi pemerintahan, layanan publik, berita, dan potensi desa." },
      { name: "keywords", content: "Desa Tegalsari, Sidareja, Cilacap, Jawa Tengah, pemerintah desa, website desa, layanan desa, APBDes" },
      ...
      { name: "twitter:description", content: "Website resmi Desa Tegalsari, Kabupaten Cilacap, Jawa Tengah." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Pemerintah Desa Tegalsari",
          description: "Pemerintah Desa Tegalsari, Kecamatan Sidareja, Kabupaten Cilacap, Jawa Tengah.",
          areaServed: {
            "@type": "AdministrativeArea",
            name: "Desa Tegalsari, Kec. Sidareja, Kab. Cilacap, Jawa Tengah",
          },
          address: {
            "@type": "PostalAddress",
            streetAddress: "Jl. Raya Tegalsari No. 12",
            addressLocality: "Sidareja",
            addressRegion: "Jawa Tengah",
            postalCode: "53261",
            addressCountry: "ID",
          },
          telephone: "+62-282-5295148",
          email: "pemdes.tegalsari@cilacapkab.go.id",
        }),
      },
    ],
  }),
